...
.directive('angucompleteAlt', ['$q', '$parse', '$http', '$sce', '$timeout', '$templateCache', function ($q, $parse, $http, $sce, $timeout, $templateCache) {
  ...
  $templateCache.put(TEMPLATE_URL,
    ...
    '    <div class="angucomplete-searching" ng-show="!searching && (!results || results.length == 0)" ng-bind="textNoResults" ng-click="onNoResultsClick()"></div>' +
  ...
  return {
    ...
    link: function(scope, elem, attrs, ctrl) {
      ...
      if (attrs.showAddNewTag) {
        scope.textNoResults = "Add new tag";
        scope.onNoResultsClick = () => {
          handleOverrideSuggestions()
        }
      }
